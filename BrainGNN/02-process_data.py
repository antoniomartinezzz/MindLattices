...
#root_folder = '/media/SSD2/MindGraphs/data/'
root_folder = '/media/SSD2/MindGraphs/data_HO_sex/' #cambiar
...
def main():
    ...
    labels = Reader.get_subject_score(subject_IDs, score='ASD') #
    ...
    fea_corr = Reader.get_networks(subject_IDs, iter_no='', kind='correlation', atlas_name=atlas) 
    fea_pcorr = Reader.get_networks(subject_IDs, iter_no='', kind='partial correlation', atlas_name=atlas) 
...
#lo que es dos pasa a ser 0 y lo que es 1 se queda como uno (control:0, autismo:1)
