...
def subject_connectivity(timeseries, subjects, atlas_name, kind, iter_no='', seed=123,
...
def get_networks(subject_list, kind, iter_no='', seed=123, n_subjects='', atlas_name="aal",
