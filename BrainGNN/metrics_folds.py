...
parser.add_argument('--dataroot', type=str, default='/media/SSD2/MindGraphs/data_ours_D16_S8/ABIDE_pcp/cpac/filt_noglobal', help='root directory of the dataset')
...
#model_list = ['F_5F_CC200_0', 'F_5F_CC200_1' , 'F_5F_CC200_2', 'F_5F_CC200_3', 'F_5F_CC200_4']
#model_list = ['model_ASD__5F_HO_0', 'model_ASD__5F_HO_1' , 'model_ASD__5F_HO_2', 'model_ASD__5F_HO_3', 'model_ASD__5F_HO_4']
model_list = ['model_ASD_5F_OURS_0', 'model_ASD_5F_OURS_1' , 'model_ASD_5F_OURS_2', 'model_ASD_5F_OURS_3', 'model_ASD_5F_OURS_4']
...
for model_name in tqdm(model_list): 
    ...
    for fold in range(K_fold): 
        ...
        model_path = os.path.join(folder_path, str(fold)+opt.atlas+'.pth')
